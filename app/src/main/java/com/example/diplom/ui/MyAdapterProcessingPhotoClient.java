...
public class MyAdapterProcessingPhotoClient extends RecyclerView.Adapter<MyViewHolder6> {
...
*/
   /* public void setSearchList2(ArrayList<String> name, ArrayList<byte[]> bytesbitmap, ArrayList<String> imphstr, ArrayList<String> photosession, ArrayList<String> client)
    ...
    public MyAdapterProcessingPhotoClient(Context context, ArrayList<Version> versions, ArrayList<String> id)
    {
...
//        Log.d("MSGcrim3", Arrays.toString(bytesbitmap.get(1)));
        if(versions != null) {
            ...
            updateVersionClient(id.get(position), "Не согласована");
        ...
        holder.ImageOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                updateVersionClient(id.get(position), "Согласована");
            }
        });
