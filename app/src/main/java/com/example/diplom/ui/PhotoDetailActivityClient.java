...
public class PhotoDetailActivityClient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bytes2 != null) {
            ...
            Log.d("MSGcrim123333", ""+image.size());
            ...
            serverClient.setserverListener(new ServerClient.serverListener() {
                ...
                public void onDataDownloaded() {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            GridLayoutManager gridLayoutManager1 = new GridLayoutManager(PhotoDetailActivityClient.this,1);
        ...
        }catch (JSONException e){Log.d("ERRRRROR", e.toString());}
            ...
            public void onClick(View view) {
                ...
                if(textInputEditText.getText() != null)
                {
                    ...
                    try {
                        ...
                        Log.d("MSGComphot", jsonObject2.getString("dateCreate"));
                    ...
                    }catch (JSONException e){Log.d("MSGTextfor", e.toString());}
                }
